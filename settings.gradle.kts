...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        if (artifactoryUrl != "") {
            ...
            println("debug: (settings): artifactoryUrl: $artifactoryUrl")
            println("debug: (settings): artifactoryUsername: $artifactoryUsername")
            println("debug: (settings): artifactoryPassword: $artifactoryPassword")
        }
